...
<body class="bg-light">
            ...
            <div class="col-md-6 text-center">
                <div class="card shadow-lg border-0 p-5">
                    <div class="card-body">
                        ...
                        <h2 class="fw-bold text-dark">Status Updated Successfully...!!!</h2>
                        <p class="text-muted fs-5"> 
                            Excellent Work! Deliver More, Earn More, and Stay Safe.
                        </p>
                        <h2><i class="fas fa-biking me-2 bike_color"></i>Have a safe Rides.</h2>
                        ...
                        <div class="d-grid gap-2 mt-4">
                            <a href="Update_Delivery_Status.jsp" class="btn btn-primary btn-lg">
    ...
    <script>
        ...
        setInterval(() => {
            ...
            if(timeLeft === 0) {
                window.location.href = "Update_Delivery_Status.jsp";
            }
        }, 1000);
    </script>
