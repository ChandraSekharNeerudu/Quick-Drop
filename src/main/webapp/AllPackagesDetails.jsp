		...
		<div class="row">
			<div class="col-12">
				<h4 class="text-center text-danger">
					<b>Packages Details Table</b>
				</h4>
				<div class="card shadow-sm border-0 hey">
					<div class="card-header bg-secondary py-3">
						<h4 class="mb-0 text-dark fw-bold">
							<i class="fas fa-home me-2 home_icon"></i> All Packages list
						</h4>
					</div>
					<div class="card-body p-0">
                        ...
                        <th class="text-danger">Delete </th>-->
								...
								%>
								<tr>
									<td colspan="12" class="text-center py-5 text-muted"><i
										class="fas fa-parachute-box fa-2x d-block mb-3"></i> No
										Packages are there yet.</td>
								</tr>
								<% } %>
							</table>
						</div>
			...
			<div class="col-md-4 pl-3">
				...
				<ul class="pagination">
					<li class="page-item ${currentPage == 1 ? 'disabled' : ''} ">
						<a class="page-link"
						href="PackageDetailsController?page=${currentPage - 1}">Previous</a>
					</li>
					<li class="page-item"><a class="page-link"
						href="PackageDetailsController?page=${currentPage}">Page:${currentPage}</a></li>
					<li
						class="page-item ${currentPage >= totalPkgPages ? 'disabled' : ''}">
						<a class="page-link"
						href="PackageDetailsController?page=${currentPage + 1}">Next Page</a>
					</li>
				</ul>
				</nav>
			</div>
